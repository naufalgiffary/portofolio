...
new TypeIt("#type1", {
  ...
  .type("Mobile Apps Developer", { delay: 400 })
  .pause(500)
  .delete(21)
...
//Social Media
function gitsocmed() {
  window.location.href = 'https://github.com/naufalgiffary?tab=repositories'
}

function igsocmed() {
  window.location.href = 'https://www.instagram.com/naufalgiff/'
}

function lisocmed() {
  window.location.href = 'https://www.linkedin.com/in/naufal-algiffary-677383202/'
}